# QE vs Timing Identification Assessment

Date: 2026-05-15

This memo compares QE-centered ECB surprise instruments against conventional timing surprises for the balance-sheet thesis architecture. It does not estimate LP-IV responses.

## Answer

QE provides materially stronger identification than timing for this thesis architecture.
...
QE is the economically natural candidate for a balance-sheet transmission thesis, but it must still clear instrument relevance. If QE strength appears mainly against DFR and not against ECB assets, household loans, NFC loans, or housing, it is not enough to justify a QE baseline by itself.
