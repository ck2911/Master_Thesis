...
| --- | --- | --- | --- | --- | --- | --- |
| weighted_variants | usable_F10 | unstable_or_unproven | 13.776 | 0.230 | tests event-intensity and crisis leverage | yes |
| monthly_bridge | usable_F10 | unstable_or_unproven | 13.387 | 0.143 | tests whether quarterly aggregation destroyed signal | yes |
| fg | usable_F10 | unstable_or_unproven | 13.239 | 0.140 | communication channel robustness | yes |
| target | usable_F10 | regime_supported | 11.258 | 0.122 | short-rate target shock robustness | yes |
| qe | borderline | unstable_or_unproven | 9.173 | 0.166 | closest fit to balance-sheet transmission | weak_caution |
| composite | weak | unstable_or_unproven | 4.532 | 0.053 | captures shared ECB surprise variation | no |
| timing | weak | unstable_or_unproven | 2.958 | 0.035 | conventional rate-news fit, weak balance-sheet fit | no |
...
Final SVECM estimation, FEVDs, historical decompositions, counterfactuals, welfare claims, and policy conclusions remain closed. The next allowed stage is LP-IV infrastructure validation.
