# Intermediation Mechanism Assessment

Date: 2026-05-16

This layer adds banking and lending timing evidence to the monthly reduced-form LP framework. It is deliberately framed as ordered timing evidence and timing-consistent financial propagation, not a bank-channel treatment effect.
...
Banking and lending variables are evaluated for whether they respond earlier or more persistently than downstream housing-finance and wage-pressure proxies. That supports intermediation-consistent dynamics only as timing evidence. The thesis should avoid bank-to-distribution treatment-effect claims, exact structural magnitudes, and welfare interpretation.
